        ...
        <>
          ...
          <div className="relative flex-shrink-0" style={{ height: 68,
            ...
            <div className="absolute inset-0 opacity-[0.06]"
              style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.8) 5px, rgba(255,255,255,0.8) 6px)' }} />
          </div>
        </>
      )}
      ...
      <div className="flex flex-1 flex-col px-5 pb-5">
        ...
        {mode !== 'full' ? (
          <div className="flex items-end gap-3 -mt-8">
            {mode === 'circle' && (
              <div className="relative z-10 flex-shrink-0 overflow-hidden rounded-full border-[3px] border-white shadow-lg"
            ...
            {mode === 'card' && (
              <div className="relative z-10 flex-shrink-0 overflow-hidden border-[2.5px] border-white shadow-lg"
          ...
          <div className="space-y-1.5">
            {data.email && (
              <div className="flex items-center gap-2">
                ...
                <p className="truncate text-[8px]" style={{ color: c.primary, opacity: 0.6 }}>{data.email}</p>
              </div>
            )}
            {data.phone && (
              <div className="flex items-center gap-2">
                <span className="w-3.5 flex-shrink-0 text-[10px]">📞</span>
                <p className="text-[8px]" style={{ color: c.primary, opacity: 0.6 }}>{data.phone}</p>
              </div>
            )}
          </div>
        )}
