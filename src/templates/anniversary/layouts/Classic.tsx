...
export function AnniClassic({ data, c }: LayoutProps) {
  return (
    <div className="relative flex h-full w-full flex-col items-center overflow-hidden pb-7"
      ...
      {/* Portrait photo with double-frame */}
      ...
      <p className="relative z-10 mt-5 px-6 text-center text-[21px] font-bold leading-tight"
        style={{ fontFamily: 'Georgia, serif', color: c.primary, letterSpacing: '0.02em' }}>
        {data.title || 'Tên đôi'}
      </p>
