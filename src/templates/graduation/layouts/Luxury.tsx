...
export function GradLuxury({ data, c }: LayoutProps) {
  return (
    <div className="relative flex h-full w-full flex-col items-center overflow-hidden pb-8"
      style={{ backgroundColor: c.accent }}>

      {/* Ambient gold glow — large, top center */}
      ...
      {/* Portrait photo — clean, elegant */}
      <div className="relative z-10 mt-6 flex-shrink-0">
        {/* Outer gold glow (doesn't clip — stays inside parent bounds) */}
        <div className="absolute inset-0 rounded-xl"
          style={{
            boxShadow: `0 0 0 1px ${c.secondary}40, 0 0 28px ${c.secondary}28, 0 16px 40px rgba(0,0,0,0.65)`,
          }} />
        <div className="overflow-hidden rounded-xl"
          style={{
            width: 116,
            height: 144,
            border: `1.5px solid ${c.secondary}99`,
          }}>
          {data.imageUrl
      ...
      {/* Name */}
      <p className="relative z-10 mt-6 px-6 text-center text-[22px] font-bold leading-tight"
        style={{
