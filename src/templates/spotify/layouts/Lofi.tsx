  ...
  return (
    <div className="relative flex min-h-full w-full flex-col overflow-hidden"
      ...
      <div className="relative z-10 flex items-center justify-center gap-2">
        ...
        <p className="text-[7px] font-bold tracking-[0.5em] uppercase" style={{ color:c.primary, opacity:.6 }}>lo-fi beats</p>
      ...
      <p className="relative z-10 mt-1 text-center text-[10px] font-semibold tracking-[0.2em] uppercase"
      ...
      <div className="relative z-10 mx-auto mt-3 flex items-center gap-1.5">
        ...
        <span style={{ fontSize:10, color:c.primary, opacity:.4 }}>♪</span>
        <div style={{ width:28, height:1.5, background:c.primary, opacity:.35, borderRadius:1 }} />
      </div>
      ...
      <button type="button" disabled={!hasUrl || !isReady || isLoading || !!error} onClick={toggle}
        ...
        <span style={{ fontSize:10.5, fontWeight:700, letterSpacing:'.1em', textTransform:'uppercase',
      ...
      {hasUrl && (
        <a href={data.spotifyUrl} target="_blank" rel="noopener noreferrer"
          ...
          <span style={{ fontSize: 9.5, fontWeight: 700, color: c.primary, letterSpacing: '.1em', textTransform: 'uppercase', fontFamily: 'Georgia, serif' }}>Mở trên Spotify</span>
        </a>
      )}
      ...
      <div className="relative z-10 mt-auto flex items-center justify-center gap-1 pb-4 pt-3">
        ...
        <span style={{ fontSize:9, color:c.primary, opacity:.25 }}>♪</span>
        <span style={{ fontSize:11, opacity:.22 }}>☕</span>
      </div>
    </div>
  );
