  ...
  return (
    <div className="relative flex min-h-full w-full flex-col items-center overflow-hidden"
      ...
      <div className="relative z-10 flex items-center gap-1.5 rounded-full px-3.5 py-1"
        ...
        <span className="text-[7px] font-bold tracking-[0.5em] uppercase" style={{ color: c.primary }}>Spotify</span>
      </div>
      ...
      <p className="relative z-10 mt-1 text-center text-[10px] font-semibold tracking-[0.26em] uppercase"
      ...
      <button type="button" disabled={!hasUrl || !isReady || isLoading || !!error} onClick={toggle}
        ...
        <span style={{ fontSize: 11, fontWeight: 800, letterSpacing: '.14em', textTransform: 'uppercase',
