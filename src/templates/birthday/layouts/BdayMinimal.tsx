...
export function BdayMinimal({ data, c }: LayoutProps) {
  ...
  return (
    <div
      className="flex h-full w-full flex-col justify-between px-6 pt-7 pb-7"
    ...
    >
      ...
      <div>
        ...
        <p
          className="mt-1.5 leading-none font-bold"
      ...
      {mode === 'full' && (
        <div className="overflow-hidden rounded-2xl shadow-sm" style={{ height: 132 }}>
          {data.imageUrl ? (
            ...
            <div
              className="flex h-full w-full items-center justify-center text-4xl opacity-25"
